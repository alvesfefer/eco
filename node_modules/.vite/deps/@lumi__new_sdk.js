...
function wordsToMd5(x2, len) {
  ...
  return Uint32Array.of(a, b2, c2, d2);
}
...
function md5ff(a, b2, c2, d2, x2, s2, t) {
  return md5cmn(b2 & c2 | ~b2 & d2, a, b2, x2, s2, t);
}
function md5gg(a, b2, c2, d2, x2, s2, t) {
  return md5cmn(b2 & d2 | c2 & ~d2, a, b2, x2, s2, t);
}
function md5hh(a, b2, c2, d2, x2, s2, t) {
  return md5cmn(b2 ^ c2 ^ d2, a, b2, x2, s2, t);
}
function md5ii(a, b2, c2, d2, x2, s2, t) {
  return md5cmn(c2 ^ (b2 | ~d2), a, b2, x2, s2, t);
}
var md5_default = md5;
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N2; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T2 = ROTL(a, 5) + f(s2, b2, c2, d2) + e + K2[s2] + W[t] >>> 0;
      e = d2;
      d2 = c2;
      c2 = ROTL(b2, 30) >>> 0;
      b2 = a;
...
var k = (i, e, t) => e in i ? B(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var v = (i, e) => {
  for (var t in e || (e = {})) G.call(e, t) && k(i, t, e[t]);
  if (N) for (var t of N(e)) J.call(e, t) && k(i, t, e[t]);
  return i;
};
var j = (i, e, t) => e.has(i) || $("Cannot " + t);
var s = (i, e, t) => (j(i, e, "read from private field"), t ? t.call(i) : e.get(i));
var l = (i, e, t) => e.has(i) ? $("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t);
var m = (i, e, t, r2) => (j(i, e, "write to private field"), r2 ? r2.call(i, t) : e.set(i, t), t);
var c = (i, e, t) => new Promise((r2, a) => {
  var n = (g) => {
    try {
      y(t.next(g));
    } catch (h) {
  ...
  }, y = (g) => g.done ? r2(g.value) : Promise.resolve(g.value).then(n, p);
  y((t = t.apply(i, e)).next());
});
function o(i, e, t = {}) {
  return i.auth.accessToken && (t.headers = v({ Authorization: `Bearer ${i.auth.accessToken}` }, t.headers)), ofetch(e, v({ baseURL: i.config.apiBaseUrl }, t));
}
function q() {
  var i, e;
...
function D(i, e, t = localStorage) {
  let r2 = t.getItem(i), a = e ? JSON.stringify(e) : null;
  a ? t.setItem(i, a) : t.removeItem(i), window.dispatchEvent(new StorageEvent("storage", { key: i, oldValue: r2, newValue: a, storageArea: t }));
}
function M(i, e = localStorage) {
  let t = e.getItem(i);
  try {
...
var C = class {
  constructor(e) {
    l(this, d);
    l(this, S, `lumi-auth-${v4_default()}`);
    m(this, d, e);
  }
  get accessToken() {
    return M("lumi-access-token");
  }
  set accessToken(e) {
    D("lumi-access-token", e);
  }
  get user() {
    return M("lumi-user");
  }
  ...
  signIn() {
    let r2 = (window.screen.width - 800) / 2, a = (window.screen.height - 600) / 2, n = window.open(s(this, d).config.authOrigin, s(this, S), `width=800,height=600,left=${r2},top=${a}`), p;
    return new Promise((y, g) => {
      if (!n) return g(new Error("Open auth window failed"));
      let h = setInterval(() => {
        n.closed && g(new Error("Auth window closed"));
      }, 1e3), U = ({ data: w, origin: _, source: F }) => {
        if (!(_ !== s(this, d).config.authOrigin || F !== n)) switch (w == null ? void 0 : w.type) {
          case "lumi-ready": {
            n.postMessage({ type: "lumi-init", data: { projectId: s(this, d).config.projectId, icon: q(), title: K() } }, s(this, d).config.authOrigin);
            break;
          }
          case "lumi-sign-in": {
            if (w.data.projectId !== s(this, d).config.projectId) break;
            n.close(), window.focus(), this.accessToken = w.data.accessToken, this.user = w.data.user, y(w.data);
            break;
          }
        }
      };
      window.addEventListener("message", U), p = () => {
        clearInterval(h), window.removeEventListener("message", U);
      };
    }).finally(() => p == null ? void 0 : p());
  }
  signOut() {
  ...
  refreshUser() {
    return c(this, null, function* () {
      let e = yield o(s(this, d), "/lm/user/info", { method: "POST" });
...
d = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap();
var u;
var I = class {
  constructor(e, t) {
    l(this, u);
    m(this, u, e), this.entityName = t;
  }
  list() {
    return c(this, arguments, function* ({ filter: e, sort: t, limit: r2, skip: a } = {}) {
      if (r2) {
        let n = yield o(s(this, u), this.uri("/find"), { method: "POST", body: { filter: e, sort: t, limit: r2, skip: a } });
        if (n.code !== 200) throw new Error(n.message);
        return n.data;
      } else {
        let n = yield o(s(this, u), this.uri("/list"), { method: "POST", body: { filter: e, sort: t } });
        if (n.code !== 200) throw new Error(n.message);
        return { total: n.data.length, list: n.data };
      }
    });
  }
  get(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, u), this.uri(`/${e}`), { method: "GET" });
  ...
  create(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, u), this.uri(), { method: "POST", body: e });
      if (t.code !== 200) throw new Error(t.message);
      return t.data;
    });
  }
  createMany(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, u), this.uri("/batch"), { method: "POST", body: e });
      if (t.code !== 200) throw new Error(t.message);
      return t.data;
    });
  }
  update(e, t) {
    return c(this, null, function* () {
      let r2 = yield o(s(this, u), this.uri(), { method: "PUT", body: { filter: { _id: e }, update: t } });
  ...
  delete(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, u), this.uri(`/${e}`), { method: "DELETE" });
      if (t.code !== 200) throw new Error(t.message);
    });
  }
  deleteMany(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, u), this.uri("/batch-by-ids"), { method: "DELETE", params: { ids: e } });
      if (t.code !== 200) throw new Error(t.message);
    });
  }
  uri(e = "") {
    return `/lm/${s(this, u).config.projectId}/${this.entityName}/documents${e}`;
  }
};
...
var L = class {
  constructor(e) {
    l(this, T);
    return m(this, T, e), new Proxy(this, { get(t, r2) {
      return r2 in t || (t[r2] = new I(s(t, T), r2)), t[r2];
    } });
  }
};
...
var x = class {
  ...
  send(g) {
    return c(this, arguments, function* ({ to: e, subject: t, fromName: r2, html: a, text: n = "", replyTo: p, scheduledAt: y }) {
      if (!e || !t || !a && !n) throw new Error("Failed to send email: Missing required parameters.");
      typeof e == "string" && (e = [e]), typeof p == "string" && (p = [p]);
      let h = yield o(s(this, b), `/lm/${s(this, b).config.projectId}/email/send`, { method: "POST", body: { to: e, subject: t, fromName: r2, html: a, text: n, replyTo: p, scheduledAt: y } });
      if (h.code !== 200) throw new E(h.code, h.message);
    });
  }
};
...
var A = class {
  ...
  upload(e) {
    return c(this, null, function* () {
      ...
      let r2 = yield o(s(this, f2), `/lm/${s(this, f2).config.projectId}/file/batch`, { method: "POST", body: t });
  ...
  delete(e) {
    return c(this, null, function* () {
      let t = yield o(s(this, f2), `/lm/${s(this, f2).config.projectId}/file/batch`, { method: "DELETE", body: { fileUrls: e } });
...
var R = class {
  constructor(e) {
    l(this, P);
    m(this, P, e), this.email = new x(e), this.file = new A(e);
  }
};
P = /* @__PURE__ */ new WeakMap();
var O = class {
  constructor(e) {
    this.config = e, this.auth = new C(this), this.entities = new L(this), this.tools = new R(this);
  }
};
function Ae(i) {
  return new O(i);
